...
@Composable
fun ListeningExplanationScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        try {
            val filename = "android.resource://${context.packageName}/raw/listening"
    ...
    Column(
                ...
                Row(
                    ...
                    Text(
                        "Listening! \uD83C\uDFA7\n" +
                                ...
                                "3. Put it in order.\n" +
                                "\n" +
                                "It's not only interesting, but it will also help you understand English better by ear!\n" +
                                "\n" +
        ...
        Row(
            ...
            Button(
                ...
                onClick = {
                    onNavigateToScreen.invoke(Screen.ListeningTest)
                },
