...
fun ReadingExplanationScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        try {
            val filename = "android.resource://${context.packageName}/raw/reading"
    ...
    Column(
                ...
                Row(
                    ...
                    Text(
                        "Reading! \uD83D\uDCD9\n" +
                                ...
                                "\n" +
                                "It's not only interesting, but it will also help you understand English better by reading!\n" +
                                "\n" +
        ...
        Row(
            ...
            Button(
                ...
                onClick = {
                    onNavigateToScreen.invoke(Screen.ReadingTest)
                },
